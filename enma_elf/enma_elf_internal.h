...
typedef struct {
    ...
    uint32_t        vd_next;                /* Offset in bytes to next verdef
                                             entry */
} elf32_verdef;
...
typedef struct {
    ...
    uint32_t        vn_file;                /* Offset of filename for this
                                             dependency */
    uint32_t        vn_aux;                        /* Offset in bytes to vernaux array */
    uint32_t        vn_next;                /* Offset in bytes to next verneed
                                             entry */
} elf32_verneed;
...
typedef struct {
    ...
    uint32_t        vna_next;                /* Offset in bytes to next vernaux
                                             entry */
} elf32_vernaux;
